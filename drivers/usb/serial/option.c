...
#define CINTERION_PRODUCT_MV31			0x00b3
...
//	{ USB_DEVICE_INTERFACE_CLASS(CINTERION_VENDOR_ID, CINTERION_PRODUCT_MV31, 0xff) },
	{ USB_DEVICE(CINTERION_VENDOR_ID, CINTERION_PRODUCT_MV31),
	  .driver_info = BIT(0)|BIT(1)|BIT(3) },
