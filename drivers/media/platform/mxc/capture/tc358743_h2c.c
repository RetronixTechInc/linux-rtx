...
#define TC358743_XCLK_MIN 26000000
...
/*/only 1280x720 60
,
...
static s32 tc358743_write_reg(struct sensor_data *sensor, u16 reg, u32 val, int len)
{
	...
	if ((reg < 0x7000) || (reg >= 0x7100)) {
		if (0) pr_debug("Tom=== %s:reg=%x,val=%x 8543=%02x\n", __func__, reg, val, tc358743_read_reg_val(sensor, 0x8543));
	}
	return 0;
}

static void i2c1_h2c_write8(u16 reg, u32 val)
{
	struct tc_data *td = g_td;
	struct sensor_data *sensor = &td->sensor;
	
	tc358743_write_reg(sensor, reg, val, 1);
}

static void i2c1_h2c_write16(u16 reg, u32 val)
{
	struct tc_data *td = g_td;
	struct sensor_data *sensor = &td->sensor;
	
	tc358743_write_reg(sensor, reg, val, 2);
}

static void i2c1_h2c_write32(u16 reg, u32 val)
{
	struct tc_data *td = g_td;
	struct sensor_data *sensor = &td->sensor;
	
	tc358743_write_reg(sensor, reg, val, 4);
}
...
static int ioctl_g_ifparm(struct v4l2_int_device *s, struct v4l2_ifparm *p)
{
	...
	memset(p, 0, sizeof(*p));
	p->u.bt656.clock_curr = sensor->mclk; //sensor->mclk;
...
static void tc358743_get_audiorate(struct sensor_data *sd)
{
	int ret;
	u32 u32val;
	struct tc_data *td = g_td;
...
static void tc358743_set_hdmi_audio(void)
{
// Software Reset
i2c1_h2c_write16(0x0002,0x0F00); // SysCtl
i2c1_h2c_write16(0x0002,0x0000); // SysCtl
// FIFO Delay Setting
i2c1_h2c_write16(0x0006,0x0190); // FIFO Ctl
// PLL Setting
...
// Interrupt Control
i2c1_h2c_write16(0x0014,0x0000); // IntStatus
i2c1_h2c_write16(0x0016,0x05FF); // IntMask
// CSI Lane Enable
...
i2c1_h2c_write32(0x0210,0x00000FA0); // LINEINITCNT
i2c1_h2c_write32(0x0214,0x00000004); // LPTXTIMECNT
i2c1_h2c_write32(0x0218,0x00001503); // TCLK_HEADERCNT
i2c1_h2c_write32(0x021C,0x00000001); // TCLK_TRAILCNT
i2c1_h2c_write32(0x0220,0x00000103); // THS_HEADERCNT
i2c1_h2c_write32(0x0224,0x00003A98); // TWAKEUP
i2c1_h2c_write32(0x0228,0x00000008); // TCLK_POSTCNT
i2c1_h2c_write32(0x022C,0x00000002); // THS_TRAILCNT
i2c1_h2c_write32(0x0230,0x00000005); // HSTXVREGCNT
i2c1_h2c_write32(0x0234,0x0000001F); // HSTXVREGEN
i2c1_h2c_write32(0x0238,0x00000001); // TXOPTIONACNTRL
i2c1_h2c_write32(0x0204,0x00000001); // STARTCNTRL
i2c1_h2c_write32(0x0518,0x00000001); // CSI_START
i2c1_h2c_write32(0x0500,0xA3008086); // CSI_CONFW
// HDMI Interrupt Mask
i2c1_h2c_write8(0x8502,0x01); // SYS_INT
i2c1_h2c_write8(0x8512,0xFE); // SYS_INTM
i2c1_h2c_write8(0x8514,0x00); // PACKET_INTM
i2c1_h2c_write8(0x8515,0x00); // AUDIO_IMNTM
i2c1_h2c_write8(0x8516,0x00); // ABUF_INTM
// HDMI Audio REFCLK
...
i2c1_h2c_write8(0x8C36,0x10); // EDID_RAM
i2c1_h2c_write8(0x8C37,0x27); // EDID_RAM
i2c1_h2c_write8(0x8C38,0x00); // EDID_RAM
i2c1_h2c_write8(0x8C39,0x72); // EDID_RAM
i2c1_h2c_write8(0x8C3A,0x51); // EDID_RAM
i2c1_h2c_write8(0x8C3B,0xC0); // EDID_RAM
i2c1_h2c_write8(0x8C3C,0x35); // EDID_RAM
i2c1_h2c_write8(0x8C3D,0x30); // EDID_RAM
i2c1_h2c_write8(0x8C3E,0x6E); // EDID_RAM
i2c1_h2c_write8(0x8C3F,0x28); // EDID_RAM
i2c1_h2c_write8(0x8C40,0x45); // EDID_RAM
i2c1_h2c_write8(0x8C41,0x00); // EDID_RAM
i2c1_h2c_write8(0x8C42,0x66); // EDID_RAM
i2c1_h2c_write8(0x8C43,0x4C); // EDID_RAM
i2c1_h2c_write8(0x8C44,0x00); // EDID_RAM
i2c1_h2c_write8(0x8C45,0x00); // EDID_RAM
i2c1_h2c_write8(0x8C46,0x00); // EDID_RAM
i2c1_h2c_write8(0x8C47,0x18); // EDID_RAM
i2c1_h2c_write8(0x8C48,0x10); // EDID_RAM
i2c1_h2c_write8(0x8C49,0x27); // EDID_RAM
i2c1_h2c_write8(0x8C4A,0x00); // EDID_RAM
i2c1_h2c_write8(0x8C4B,0x72); // EDID_RAM
i2c1_h2c_write8(0x8C4C,0x51); // EDID_RAM
i2c1_h2c_write8(0x8C4D,0xC0); // EDID_RAM
i2c1_h2c_write8(0x8C4E,0x35); // EDID_RAM
i2c1_h2c_write8(0x8C4F,0x30); // EDID_RAM
i2c1_h2c_write8(0x8C50,0x6E); // EDID_RAM
i2c1_h2c_write8(0x8C51,0x28); // EDID_RAM
i2c1_h2c_write8(0x8C52,0x45); // EDID_RAM
i2c1_h2c_write8(0x8C53,0x00); // EDID_RAM
i2c1_h2c_write8(0x8C54,0x66); // EDID_RAM
i2c1_h2c_write8(0x8C55,0x4C); // EDID_RAM
i2c1_h2c_write8(0x8C56,0x00); // EDID_RAM
i2c1_h2c_write8(0x8C57,0x00); // EDID_RAM
i2c1_h2c_write8(0x8C58,0x00); // EDID_RAM
i2c1_h2c_write8(0x8C59,0x18); // EDID_RAM
...
i2c1_h2c_write8(0x8C7F,0x24); // EDID_RAM
i2c1_h2c_write8(0x8C80,0x02); // EDID_RAM
i2c1_h2c_write8(0x8C81,0x03); // EDID_RAM
i2c1_h2c_write8(0x8C82,0x1A); // EDID_RAM
i2c1_h2c_write8(0x8C83,0x72); // EDID_RAM
i2c1_h2c_write8(0x8C84,0x47); // EDID_RAM
i2c1_h2c_write8(0x8C85,0x81); // EDID_RAM
i2c1_h2c_write8(0x8C86,0x82); // EDID_RAM
i2c1_h2c_write8(0x8C87,0x1B); // EDID_RAM
i2c1_h2c_write8(0x8C88,0x1B); // EDID_RAM
i2c1_h2c_write8(0x8C89,0x1B); // EDID_RAM
i2c1_h2c_write8(0x8C8A,0x1B); // EDID_RAM
i2c1_h2c_write8(0x8C8B,0x1B); // EDID_RAM
...
i2c1_h2c_write8(0x8C9A,0xBC); // EDID_RAM
i2c1_h2c_write8(0x8C9B,0x1B); // EDID_RAM
i2c1_h2c_write8(0x8C9C,0x00); // EDID_RAM
i2c1_h2c_write8(0x8C9D,0xA0); // EDID_RAM
i2c1_h2c_write8(0x8C9E,0x50); // EDID_RAM
i2c1_h2c_write8(0x8C9F,0x20); // EDID_RAM
i2c1_h2c_write8(0x8CA0,0x17); // EDID_RAM
i2c1_h2c_write8(0x8CA1,0x30); // EDID_RAM
i2c1_h2c_write8(0x8CA2,0x30); // EDID_RAM
i2c1_h2c_write8(0x8CA3,0x20); // EDID_RAM
i2c1_h2c_write8(0x8CA4,0x36); // EDID_RAM
i2c1_h2c_write8(0x8CA5,0x00); // EDID_RAM
i2c1_h2c_write8(0x8CA6,0x00); // EDID_RAM
i2c1_h2c_write8(0x8CA7,0x20); // EDID_RAM
i2c1_h2c_write8(0x8CA8,0x53); // EDID_RAM
i2c1_h2c_write8(0x8CA9,0x00); // EDID_RAM
i2c1_h2c_write8(0x8CAA,0x00); // EDID_RAM
i2c1_h2c_write8(0x8CAB,0x1A); // EDID_RAM
i2c1_h2c_write8(0x8CAC,0xBC); // EDID_RAM
i2c1_h2c_write8(0x8CAD,0x1B); // EDID_RAM
i2c1_h2c_write8(0x8CAE,0x00); // EDID_RAM
i2c1_h2c_write8(0x8CAF,0xA0); // EDID_RAM
i2c1_h2c_write8(0x8CB0,0x50); // EDID_RAM
i2c1_h2c_write8(0x8CB1,0x20); // EDID_RAM
i2c1_h2c_write8(0x8CB2,0x17); // EDID_RAM
i2c1_h2c_write8(0x8CB3,0x30); // EDID_RAM
i2c1_h2c_write8(0x8CB4,0x30); // EDID_RAM
i2c1_h2c_write8(0x8CB5,0x20); // EDID_RAM
i2c1_h2c_write8(0x8CB6,0x36); // EDID_RAM
i2c1_h2c_write8(0x8CB7,0x00); // EDID_RAM
i2c1_h2c_write8(0x8CB8,0x00); // EDID_RAM
i2c1_h2c_write8(0x8CB9,0x20); // EDID_RAM
i2c1_h2c_write8(0x8CBA,0x53); // EDID_RAM
i2c1_h2c_write8(0x8CBB,0x00); // EDID_RAM
i2c1_h2c_write8(0x8CBC,0x00); // EDID_RAM
i2c1_h2c_write8(0x8CBD,0x1A); // EDID_RAM
i2c1_h2c_write8(0x8CBE,0xBC); // EDID_RAM
i2c1_h2c_write8(0x8CBF,0x1B); // EDID_RAM
i2c1_h2c_write8(0x8CC0,0x00); // EDID_RAM
i2c1_h2c_write8(0x8CC1,0xA0); // EDID_RAM
i2c1_h2c_write8(0x8CC2,0x50); // EDID_RAM
i2c1_h2c_write8(0x8CC3,0x20); // EDID_RAM
i2c1_h2c_write8(0x8CC4,0x17); // EDID_RAM
i2c1_h2c_write8(0x8CC5,0x30); // EDID_RAM
i2c1_h2c_write8(0x8CC6,0x30); // EDID_RAM
i2c1_h2c_write8(0x8CC7,0x20); // EDID_RAM
i2c1_h2c_write8(0x8CC8,0x36); // EDID_RAM
i2c1_h2c_write8(0x8CC9,0x00); // EDID_RAM
i2c1_h2c_write8(0x8CCA,0x00); // EDID_RAM
i2c1_h2c_write8(0x8CCB,0x20); // EDID_RAM
i2c1_h2c_write8(0x8CCC,0x53); // EDID_RAM
i2c1_h2c_write8(0x8CCD,0x00); // EDID_RAM
i2c1_h2c_write8(0x8CCE,0x00); // EDID_RAM
i2c1_h2c_write8(0x8CCF,0x1A); // EDID_RAM
i2c1_h2c_write8(0x8CD0,0xBC); // EDID_RAM
i2c1_h2c_write8(0x8CD1,0x1B); // EDID_RAM
i2c1_h2c_write8(0x8CD2,0x00); // EDID_RAM
i2c1_h2c_write8(0x8CD3,0xA0); // EDID_RAM
i2c1_h2c_write8(0x8CD4,0x50); // EDID_RAM
i2c1_h2c_write8(0x8CD5,0x20); // EDID_RAM
i2c1_h2c_write8(0x8CD6,0x17); // EDID_RAM
i2c1_h2c_write8(0x8CD7,0x30); // EDID_RAM
i2c1_h2c_write8(0x8CD8,0x30); // EDID_RAM
i2c1_h2c_write8(0x8CD9,0x20); // EDID_RAM
i2c1_h2c_write8(0x8CDA,0x36); // EDID_RAM
i2c1_h2c_write8(0x8CDB,0x00); // EDID_RAM
i2c1_h2c_write8(0x8CDC,0x00); // EDID_RAM
i2c1_h2c_write8(0x8CDD,0x20); // EDID_RAM
i2c1_h2c_write8(0x8CDE,0x53); // EDID_RAM
i2c1_h2c_write8(0x8CDF,0x00); // EDID_RAM
i2c1_h2c_write8(0x8CE0,0x00); // EDID_RAM
i2c1_h2c_write8(0x8CE1,0x1A); // EDID_RAM
...
i2c1_h2c_write8(0x8CFF,0x5E); // EDID_RAM
// HDCP Setting
// Video Setting
i2c1_h2c_write8(0x8573,0x81); // VOUT_SET2
// HDMI Audio Setting
