...
/* -------------------------------------------------------------------------------------------------------------------------------------- */
/* Keep power for SOC */
static void efm32_keeppower( struct efm32_a6_data *efm32data , int enable )
{
	if ( efm32data )
	{
...
/**/
static void efm32_boot( struct efm32_a6_data *efm32data , int enable )
{
	if ( efm32data )
	{
...
/* Reset MCU */
static void efm32_reset( struct efm32_a6_data *efm32data , int enable )
{
	if ( efm32data )
	{
